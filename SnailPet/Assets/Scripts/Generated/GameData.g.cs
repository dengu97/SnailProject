...
namespace SnailPet.Data
{
    ...
    public sealed class PartsDataRow
    {
        ...
        public PartsDataRow(int id, int nameId, int partsGroupId, RarityType rarityType, PartsType partsType, string resourceKey, bool isUseColor, string[] colors, int appearWeight, int infoId, int? sellItem, double sellCount, double? animFps, int? mutationGroup, int? mutationWeight, string effectPath)
        {
            Id = id;
            NameId = nameId;
    ...
    public static class GameData
    {
        ...
        {
            new PartsDataRow(1, 1, 2, RarityType.Common, PartsType.Shell, "commonshell01", true, new string[] { "commonshell01_c01" }, 10, 57, 36, 5d, null, 312, 5, null),
            new PartsDataRow(3, 3, 2, RarityType.Common, PartsType.Shell, "commonshell01", true, new string[] { "commonshell01_c02" }, 10, 58, 36, 5d, null, 312, 5, null),
            new PartsDataRow(4, 4, 2, RarityType.Common, PartsType.Shell, "commonshell01", true, new string[] { "commonshell01_c03" }, 10, 59, 36, 5d, null, 312, 5, null),
            new PartsDataRow(5, 5, 2, RarityType.Common, PartsType.Shell, "commonshell01", true, new string[] { "commonshell01_c04" }, 10, 60, 36, 5d, null, 312, 5, null),
            new PartsDataRow(6, 6, 2, RarityType.Common, PartsType.Shell, "commonshell01", true, new string[] { "commonshell01_c05" }, 10, 61, 36, 5d, null, 312, 5, null),
            new PartsDataRow(7, 7, 2, RarityType.Common, PartsType.Shell, "commonshell01", true, new string[] { "commonshell01_c06" }, 10, 62, 36, 5d, null, 312, 5, null),
            new PartsDataRow(8, 8, 2, RarityType.Common, PartsType.Shell, "commonshell01", true, new string[] { "commonshell01_c07" }, 10, 63, 36, 5d, null, 312, 5, null),
            new PartsDataRow(9, 9, 2, RarityType.Common, PartsType.Shell, "commonshell01", true, new string[] { "commonshell01_c08" }, 10, 64, 36, 5d, null, 312, 5, null),
            new PartsDataRow(10, 10, 2, RarityType.Common, PartsType.Shell, "commonshell02", true, new string[] { "commonshell02_c01" }, 10, 331, 36, 5d, null, 313, 5, null),
            new PartsDataRow(11, 11, 2, RarityType.Common, PartsType.Shell, "commonshell02", true, new string[] { "commonshell02_c02" }, 10, 331, 36, 5d, null, 313, 5, null),
            new PartsDataRow(12, 12, 2, RarityType.Common, PartsType.Shell, "commonshell02", true, new string[] { "commonshell02_c03" }, 10, 331, 36, 5d, null, 313, 5, null),
            new PartsDataRow(13, 13, 2, RarityType.Common, PartsType.Shell, "commonshell02", true, new string[] { "commonshell02_c04" }, 10, 331, 36, 5d, null, 313, 5, null),
            new PartsDataRow(14, 14, 2, RarityType.Common, PartsType.Shell, "commonshell02", true, new string[] { "commonshell02_c05" }, 10, 331, 36, 5d, null, 313, 5, null),
            new PartsDataRow(15, 15, 2, RarityType.Common, PartsType.Shell, "commonshell02", true, new string[] { "commonshell02_c06" }, 10, 331, 36, 5d, null, 313, 5, null),
            new PartsDataRow(332, 332, 2, RarityType.Common, PartsType.Shell, "commonshell02", true, new string[] { "commonshell02_c07" }, 10, 331, 36, 5d, null, 313, 5, null),
            new PartsDataRow(16, 16, 17, RarityType.Rare, PartsType.Shell, "rareshell01", true, new string[] { "rareshell01_c01" }, 7, 71, 36, 10d, null, 314, 5, null),
            new PartsDataRow(147, 147, 17, RarityType.Rare, PartsType.Shell, "rareshell02", true, new string[] { "rareshell02_c01" }, 7, 148, 36, 10d, null, 314, 5, null),
            new PartsDataRow(168, 168, 169, RarityType.Epic, PartsType.Shell, "epicshell01", true, new string[] { "epicshell01_c01" }, 5, 170, 36, 20d, null, 315, 5, null),
            new PartsDataRow(171, 171, 169, RarityType.Epic, PartsType.Shell, "epicshell01", true, new string[] { "epicshell01_c02" }, 5, 170, 36, 20d, null, 315, 5, null),
            new PartsDataRow(191, 191, 2, RarityType.Common, PartsType.Shell, "commonshell03", false, System.Array.Empty<string>(), 10, 192, 36, 5d, null, 312, 5, null),
            new PartsDataRow(202, 202, 17, RarityType.Rare, PartsType.Shell, "mellonshell", false, System.Array.Empty<string>(), 7, 203, 36, 10d, null, 316, 5, null),
            new PartsDataRow(18, 18, 2, RarityType.Common, PartsType.Body, "commonbody01", true, new string[] { "commonbody01_c01" }, 10, 72, 36, 5d, null, 317, 5, null),
            new PartsDataRow(19, 19, 2, RarityType.Common, PartsType.Body, "commonbody01", true, new string[] { "commonbody01_c02" }, 10, 73, 36, 5d, null, 317, 5, null),
            new PartsDataRow(20, 20, 2, RarityType.Common, PartsType.Body, "commonbody01", true, new string[] { "commonbody01_c03" }, 10, 74, 36, 5d, null, 317, 5, null),
            new PartsDataRow(102, 102, 2, RarityType.Common, PartsType.Body, "commonbody01", true, new string[] { "commonbody01_c04" }, 10, 103, 36, 5d, null, 317, 5, null),
            new PartsDataRow(104, 104, 2, RarityType.Common, PartsType.Body, "commonbody01", true, new string[] { "commonbody01_c05" }, 10, 105, 36, 5d, null, 317, 5, null),
            new PartsDataRow(106, 106, 2, RarityType.Common, PartsType.Body, "commonbody01", true, new string[] { "commonbody01_c06" }, 10, 107, 36, 5d, null, 317, 5, null),
            new PartsDataRow(193, 193, 2, RarityType.Common, PartsType.Body, "commonbody01", true, new string[] { "commonbody01_c07" }, 10, 194, 36, 5d, null, 317, 5, null),
            new PartsDataRow(172, 172, 2, RarityType.Common, PartsType.Body, "commonbody01", true, new string[] { "tomatobody" }, 10, 173, 36, 5d, null, 317, 5, null),
            new PartsDataRow(21, 21, 2, RarityType.Common, PartsType.Body, "commonbody02", true, new string[] { "commonbody02_c01" }, 10, 75, 36, 5d, null, 317, 5, null),
            new PartsDataRow(195, 195, 2, RarityType.Common, PartsType.Body, "commonbody05", false, System.Array.Empty<string>(), 10, 196, 36, 5d, null, 317, 5, null),
            new PartsDataRow(53, 53, 2, RarityType.Common, PartsType.Body, "commonbody03", true, new string[] { "commonbody03_c01" }, 10, 76, 36, 5d, null, 317, 5, null),
            new PartsDataRow(108, 108, 2, RarityType.Common, PartsType.Body, "commonbody03", true, new string[] { "commonbody03_c02" }, 10, 109, 36, 5d, null, 317, 5, null),
            new PartsDataRow(122, 122, 17, RarityType.Rare, PartsType.Body, "rarebody01", true, new string[] { "rarebody01_c01" }, 7, 123, 36, 10d, null, 318, 5, null),
            new PartsDataRow(164, 164, 2, RarityType.Common, PartsType.Body, "commonbody04", true, new string[] { "commonbody04_c01" }, 10, 165, 36, 5d, null, 317, 5, null),
            new PartsDataRow(174, 174, 169, RarityType.Epic, PartsType.Body, "epicbody01", false, System.Array.Empty<string>(), 5, 175, 36, 20d, null, 319, 5, null),
            new PartsDataRow(204, 204, 17, RarityType.Rare, PartsType.Body, "rarebody02", true, new string[] { "rarebody02_c01" }, 7, 205, 36, 10d, null, 318, 5, null),
            new PartsDataRow(22, 22, 2, RarityType.Common, PartsType.Eyes, "commoneyes01", false, System.Array.Empty<string>(), 10, 77, 36, 5d, null, 320, 5, null),
            new PartsDataRow(23, 23, 2, RarityType.Common, PartsType.Eyes, "commoneyes02", false, System.Array.Empty<string>(), 10, 78, 36, 5d, null, 320, 5, null),
            new PartsDataRow(24, 24, 2, RarityType.Common, PartsType.Eyes, "commoneyes03", false, System.Array.Empty<string>(), 10, 79, 36, 5d, null, 320, 5, null),
            new PartsDataRow(25, 25, 2, RarityType.Common, PartsType.Eyes, "commoneyes04", false, System.Array.Empty<string>(), 10, 80, 36, 5d, null, 320, 5, null),
            new PartsDataRow(110, 110, 2, RarityType.Common, PartsType.Eyes, "commoneyes05", false, System.Array.Empty<string>(), 10, 111, 36, 5d, null, 320, 5, null),
            new PartsDataRow(176, 176, 2, RarityType.Common, PartsType.Eyes, "commoneyes06", false, System.Array.Empty<string>(), 10, 177, 36, 5d, null, 320, 5, null),
            new PartsDataRow(197, 197, 2, RarityType.Common, PartsType.Eyes, "commoneyes06", false, System.Array.Empty<string>(), 10, 198, 36, 5d, null, 320, 5, null),
            new PartsDataRow(206, 206, 2, RarityType.Common, PartsType.Eyes, "commoneyes06", false, System.Array.Empty<string>(), 10, 207, 36, 5d, null, 320, 5, null),
            new PartsDataRow(178, 178, 169, RarityType.Epic, PartsType.Eyes, "epiceyes01", false, System.Array.Empty<string>(), 5, 179, 36, 20d, null, 321, 5, null),
            new PartsDataRow(26, 26, 2, RarityType.Common, PartsType.Feeler, "commonfeeler01", true, new string[] { "commonfeeler01_c01" }, 10, 81, 36, 5d, null, 322, 5, null),
            new PartsDataRow(138, 138, 2, RarityType.Common, PartsType.Feeler, "commonfeeler02", false, System.Array.Empty<string>(), 10, 139, 36, 5d, null, 322, 5, null),
            new PartsDataRow(54, 54, 2, RarityType.Common, PartsType.Feeler, "commonfeeler03", true, new string[] { "commonfeeler03_c01" }, 10, 86, 36, 5d, null, 322, 5, null),
            new PartsDataRow(29, 29, 2, RarityType.Common, PartsType.Feeler, "commonfeeler04", true, new string[] { "commonfeeler04_c01" }, 10, 84, 36, 5d, null, 322, 5, null),
            new PartsDataRow(180, 180, 169, RarityType.Epic, PartsType.Feeler, "epicfeeler01", false, System.Array.Empty<string>(), 5, 181, 36, 20d, null, 323, 5, null),
            new PartsDataRow(199, 199, 2, RarityType.Common, PartsType.Feeler, "plantfeeler", false, System.Array.Empty<string>(), 10, 200, 36, 5d, null, 322, 5, null),
            new PartsDataRow(182, 182, 2, RarityType.Common, PartsType.Feeler, "tomatofeeler", false, System.Array.Empty<string>(), 10, 183, 36, 6d, null, 322, 5, null),
            new PartsDataRow(184, 184, 2, RarityType.Common, PartsType.Shell, "tomatoshell", false, System.Array.Empty<string>(), 10, 185, 36, 6d, null, 312, 5, null),
            new PartsDataRow(186, 186, 17, RarityType.Rare, PartsType.Shell, "plantshell", false, System.Array.Empty<string>(), 7, 187, 36, 10d, null, 314, 5, "spark01"),
            new PartsDataRow(208, 208, 17, RarityType.Rare, PartsType.Feeler, "rarefeeler01", false, System.Array.Empty<string>(), 7, 209, 36, 6d, null, 324, 5, null),
            new PartsDataRow(210, 210, 17, RarityType.Rare, PartsType.Eyes, "rareeyes02", false, System.Array.Empty<string>(), 7, 211, 36, 6d, null, 325, 5, null),
            new PartsDataRow(212, 212, 17, RarityType.Rare, PartsType.Eyes, "rareeyes01", false, System.Array.Empty<string>(), 7, 213, 36, 6d, null, 325, 5, null),
            new PartsDataRow(214, 214, 17, RarityType.Rare, PartsType.Body, "rarebody03", true, new string[] { "rarebody03_c01" }, 7, 215, 36, 6d, null, 318, 5, null),
            new PartsDataRow(216, 216, 17, RarityType.Rare, PartsType.Shell, "tubeshell", true, new string[] { "tubeshell_c01" }, 7, 217, 36, 6d, null, 314, 5, null),
            new PartsDataRow(218, 218, 17, RarityType.Rare, PartsType.Feeler, "duckfeeler", false, System.Array.Empty<string>(), 7, 219, 36, 6d, null, 324, 5, null),
            new PartsDataRow(228, 228, 17, RarityType.Rare, PartsType.Shell, "rareshell03", true, new string[] { "rareshell03_c01" }, 7, 229, 36, 6d, null, 314, 5, null),
            new PartsDataRow(230, 230, 17, RarityType.Rare, PartsType.Shell, "rareshell03", true, new string[] { "rareshell03_c02" }, 7, 231, 36, 6d, null, 314, 5, null),
            new PartsDataRow(257, 257, 17, RarityType.Rare, PartsType.Shell, "dragonfruitshell", false, System.Array.Empty<string>(), 7, 258, 36, 6d, null, 314, 5, null),
            new PartsDataRow(259, 259, 17, RarityType.Rare, PartsType.Shell, "fishshell", false, System.Array.Empty<string>(), 7, 260, 36, 6d, null, 314, 5, null),
            new PartsDataRow(261, 261, 2, RarityType.Common, PartsType.Shell, "ballshell01", false, System.Array.Empty<string>(), 10, 262, 36, 5d, null, 312, 5, null),
            new PartsDataRow(264, 264, 2, RarityType.Common, PartsType.Shell, "ballshell02", false, System.Array.Empty<string>(), 10, 265, 36, 5d, null, 312, 5, null),
            new PartsDataRow(284, 284, 17, RarityType.Rare, PartsType.Body, "epicbody02", false, System.Array.Empty<string>(), 7, 285, 36, 6d, null, 318, 5, null),
            new PartsDataRow(286, 286, 17, RarityType.Rare, PartsType.Body, "commonbody01", true, new string[] { "slimebody" }, 7, 287, 36, 6d, null, 318, 5, null),
            new PartsDataRow(333, 333, 17, RarityType.Rare, PartsType.Body, "commonbody01", true, new string[] { "slimebody2" }, 7, 287, 36, 6d, null, 318, 5, null),
            new PartsDataRow(288, 288, 2, RarityType.Common, PartsType.Feeler, "leaffeeler", false, System.Array.Empty<string>(), 10, 289, 36, 5d, null, 322, 5, null),
            new PartsDataRow(290, 290, 2, RarityType.Common, PartsType.Eyes, "commoneyes10", false, System.Array.Empty<string>(), 10, 291, 36, 5d, null, 320, 5, null),
            new PartsDataRow(292, 292, 2, RarityType.Common, PartsType.Shell, "mushroomshell01", false, System.Array.Empty<string>(), 10, 293, 36, 5d, null, 312, 5, null),
            new PartsDataRow(294, 294, 2, RarityType.Common, PartsType.Shell, "mushroomshell02", false, System.Array.Empty<string>(), 10, 293, 36, 5d, null, 312, 5, null),
            new PartsDataRow(295, 295, 2, RarityType.Common, PartsType.Eyes, "commoneyes11", false, System.Array.Empty<string>(), 10, 296, 36, 5d, null, 320, 5, null),
            new PartsDataRow(297, 297, 17, RarityType.Rare, PartsType.Eyes, "epiceyes02", false, System.Array.Empty<string>(), 7, 298, 36, 7d, 14d, 325, 5, null),
            new PartsDataRow(299, 299, 169, RarityType.Epic, PartsType.Shell, "epicshell02", true, new string[] { "epicshell02_c01" }, 5, 300, 36, 20d, null, 326, 5, null),
            new PartsDataRow(301, 301, 17, RarityType.Rare, PartsType.Shell, "puddingshell", true, new string[] { "puddingshell_c01" }, 7, 302, 36, 6d, null, 314, 5, null),
            new PartsDataRow(334, 334, 17, RarityType.Rare, PartsType.Shell, "puddingshell", true, new string[] { "puddingshell_c02" }, 7, 302, 36, 6d, null, 314, 5, null),
            new PartsDataRow(307, 307, 2, RarityType.Common, PartsType.Shell, "breadshell01", false, System.Array.Empty<string>(), 10, 308, 36, 5d, null, 312, 5, null),
            new PartsDataRow(309, 309, 17, RarityType.Rare, PartsType.Shell, "breadshell02", true, new string[] { "breadshell02_c01" }, 7, 310, 36, 7d, null, 316, 5, null),
            new PartsDataRow(311, 311, 17, RarityType.Rare, PartsType.Shell, "breadshell02", true, new string[] { "breadshell02_c02" }, 7, 310, 36, 7d, null, 316, 5, null),
            new PartsDataRow(329, 329, 17, RarityType.Rare, PartsType.Shell, "hamburgershell", false, System.Array.Empty<string>(), 7, 330, 36, 7d, null, 316, 5, null),
            new PartsDataRow(335, 335, 169, RarityType.Epic, PartsType.Body, "lavabody", true, new string[] { "lavabody_c01" }, 5, 336, 36, 20d, null, 319, 5, null),
            new PartsDataRow(337, 337, 169, RarityType.Epic, PartsType.Body, "lavabody", true, new string[] { "lavabody_c02" }, 5, 338, 36, 20d, null, 319, 5, null),
        };
        ...
        public static readonly LanguageDataRow[] LanguageData = new LanguageDataRow[]
        {
            ...
            new LanguageDataRow(18, "바다가 생각나는 멋진 몸입니다."),
            new LanguageDataRow(19, "푸른색의 아름다운 몸입니다."),
