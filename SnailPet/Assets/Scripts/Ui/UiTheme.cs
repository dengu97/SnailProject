...
namespace SnailPet.Ui
{
    ...
    public static class UiTheme
    {
        ...
        public static class PartsGuide
        {
            ...
            /// <summary>
            /// 미리 만들어 두는 줄 수의 <b>하한</b>.
            ///
            /// 실제로 몇 줄이 필요한지는 시트에서 센다(<c>SnailUi.PartsRowsNeeded</c>) —
            /// 이 숫자를 손으로 올려야 했던 시절에는 잊을 때마다 넘치는 파츠가 목록에
            /// 아예 안 나왔고, 안 나오면 고를 수도 없어 레드닷이 영영 켜진 채로 남았다.
            /// 시트가 이보다 작아도 자리는 이만큼 잡아 둔다.
            /// </summary>
